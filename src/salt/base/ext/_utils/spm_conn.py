...
class SPMConn(GPIOSPIConn):
    ...
    def __init__(self):
        clk_pin = gpio_pin.SPI_CLK
        mosi_pin = gpio_pin.SPI_MOSI
        miso_pin = gpio_pin.SPI_MISO

        super(SPMConn, self).__init__(clk_pin, mosi_pin, miso_pin, gpio_mode=gpio_pin.MODE)
