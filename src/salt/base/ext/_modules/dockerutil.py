...
docker_executable = "balena-engine"
    ...
    **RETURN DATA**
    ...
    for registry in registries:
        ...
        try:
            ...
            cmd = [docker_executable, "login", "-u", username, "-p", password]
...
def copy_from(name, source, dest, overwrite=False, makedirs=False):
    ...
    **RETURN DATA**
    ...
    cmd = [docker_executable, "cp", src_path, dest_dir]
...
def load(path, repository=None, tag=None):
    ...
    **RETURN DATA**
    ...
    pre = images(all=True)
    cmd = [docker_executable, "load", "-i", local_path]
    time_started = time.time()
...
def layers(name):
    ...
    """
    ret = []
    cmd = [docker_executable, "history", "-q", name]
...
def save(name, path, overwrite=False, makedirs=False, compression=None, **kwargs):
    ...
    **RETURN DATA**
    ...
    cmd = [docker_executable, "save", "-o", saved_path, image_to_save]
    time_started = time.time()
