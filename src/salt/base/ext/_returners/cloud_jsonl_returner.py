...
def _get_options(ret):
    ...
    defaults = {
        ...
        "mode": "a",
        "async_writer": {
            "flush_threshold": int(1024*1024*0.5),  # 0.5MB
            "flush_timeout": 1,                     # 1 second
    ...
    if not writer or writer.closed:
        ...
        with tlock:
            ...
            if not writer or writer.closed:
                ...
                writer = AsyncWriterThread(RotatingTextFile(open_file), **options["async_writer"])
